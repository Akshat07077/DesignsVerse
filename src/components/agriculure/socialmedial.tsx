      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start mb-20">
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <div className="bg-white rounded-3xl shadow-2xl border border-[#A2E535]/10 p-8">
              ...
              <div className="space-y-4">
                {platformStats.map((platform, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-gray-50 to-white hover:from-[#A2E535]/5 hover:to-[#16A34A]/5 transition-all duration-300 group">
            ...
            <div className="bg-gradient-to-br from-[#A2E535] to-[#16A34A] rounded-3xl p-8 text-white">
              <h3 className="text-2xl font-black mb-6">Our Winning Strategy</h3>
              <div className="space-y-4">
                {[
          ...
          <div className={`sticky top-8 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`} style={{animationDelay: '300ms'}}>
            ...
            >
              {scrollableImages.map((image, index) => (
                ...
                >
                  <div className="bg-white rounded-3xl shadow-2xl border border-[#A2E535]/10 overflow-hidden group hover:shadow-3xl transition-all duration-500 hover:-translate-y-2">
                    
                    {/* Image Container */}
                    <div className="relative aspect-[3/4] bg-gradient-to-br from-[#A2E535]/10 to-[#16A34A]/10 overflow-hidden">
                      <Image
                        src={image.src}
                        alt={image.title}
                        fill
                        ...
                        <div className="absolute bottom-6 left-6 right-6">
                          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              >
                                    {/* {React.createElement(
                                    platformStats.find(p => p.name === image.platform)?.icon,
                                    { 
                                        className: "w-5 h-5",
                                        style: { 
                                        color: platformStats.find(p => p.name === image.platform)?.color 
                                        } 
                                    }
                                    )} */}
                              </div>
                            ...
                            <div className="grid grid-cols-3 gap-4 text-center">
                              <div>
                                <div className="font-black text-[#16A34A] text-lg">{image.metrics.engagement}</div>
                                <div className="text-xs text-gray-600">Engagement</div>
                              </div>
                              <div>
                                <div className="font-black text-[#16A34A] text-lg">{image.metrics.reach}</div>
                                <div className="text-xs text-gray-600">Reach</div>
                              </div>
                              <div>
                                <div className="font-black text-[#16A34A] text-lg">{image.metrics.conversions}</div>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="px-3 py-1 bg-[#A2E535]/10 rounded-full">
                          <span className="text-sm font-semibold text-[#15803D]">Case Study</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="text-center mt-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm border border-[#A2E535]/20">
                <div className="w-2 h-2 rounded-full bg-[#A2E535] animate-pulse"></div>
