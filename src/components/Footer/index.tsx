          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                Empowering Businesses with Innovative Web, ERP, and Digital Marketing Solutions for a Future-Ready Brand Experience.
                </p>
                <div className="flex items-center">
                 ...
                 <a href="https://www.instagram.com/designsverse_/" aria-label="social-link" target="_blank" rel="noopener noreferrer" class="mr-6 text-body-color duration-300 hover:text-primary dark:text-body-color-dark dark:hover:text-primary">
                    <svg height="32" width="32" viewBox="0 0 239.04 239.04" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g>
